...
(function (factory) {
  ...
  var Comments = {
    ...
    createCommentingFieldElement: function (parentId, existingCommentId, isMain) {
      ...
      var saveButtonText = existingCommentId
        ? this.options.textFormatter(this.options.saveText)
        : this.options.textFormatter(this.options.sendText);
      var saveButton = $("<span/>", {
    ...
    createCommentWrapperElement: function (commentModel) {
      ...
      var nameEl = $("<span/>", {
        ...
        text: commentModel.createdByCurrentUser
          ? this.options.textFormatter(this.options.youText)
    ...
    createCssDeclarations: function () {
      ...
      this.createCss(
        ".jquery-comments ul.navigation li.active:after {background: " + this.options.highlightColor + " !important;",
        +"}"
      );

      // Dropdown active element
      this.createCss(
        ".jquery-comments ul.navigation ul.dropdown li.active {background: " +
      ...
      this.createCss(
        ".jquery-comments .highlight-background {background: " + this.options.highlightColor + " !important;",
        +"}"
      );
      ...
      this.createCss(
        ".jquery-comments .highlight-font-bold {color: " +
          this.options.highlightColor +
          " !important;" +
          "font-weight: bold;" +
          "}"
    ...
    getAttachmentsFromCommentingField: function (commentingField) {
      var attachments = commentingField
